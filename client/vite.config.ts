...
export default defineConfig(({ command }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        globPatterns: ['**/*.{js,css,html}', 'assets/favicon.ico', 'manifest.webmanifest'],
      ...
      manifest: {
        ...
        name: 'Escape Assistant',
        description:
          'Escape Assistant is an AI-powered everyday assistant that helps you manage your calendar, email, and more.',
        start_url: '/',
        display: 'standalone',
        ...
        icons: [
          {
            src: 'https://cdn.aiescape.io/assistant/icon-48x48.png',
            sizes: '48x48',
            type: 'image/png',
          },
          {
            src: 'https://cdn.aiescape.io/assistant/icon-72x72.png',
            sizes: '72x72',
            type: 'image/png',
          },
          {
            src: 'https://cdn.aiescape.io/assistant/icon-96x96.png',
            sizes: '96x96',
            type: 'image/png',
          },
          {
            src: 'https://cdn.aiescape.io/assistant/icon-128x128.png',
            sizes: '128x128',
            type: 'image/png',
          },
          {
            src: 'https://cdn.aiescape.io/assistant/icon-144x144.png',
            sizes: '144x144',
            type: 'image/png',
          },
          {
            src: 'https://cdn.aiescape.io/assistant/icon-152x152.png',
            sizes: '152x152',
            type: 'image/png',
          },
          {
            src: 'https://cdn.aiescape.io/assistant/icon-192x192.png',
            sizes: '192x192',
            type: 'image/png',
          },
          {
            src: 'https://cdn.aiescape.io/assistant/icon-384x384.png',
            sizes: '384x384',
            type: 'image/png',
          },
          {
            src: 'https://cdn.aiescape.io/assistant/icon-512x512.png',
            sizes: '512x512',
            type: 'image/png',
          },
        ],
